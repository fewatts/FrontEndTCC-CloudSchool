    ...
    return (
        <main className='about'>
            <div id='sh'>
                ...
                <p>Somos um grupo de estudantes em transição de carreira focados no aprendizado da AWS (Amazon Web Services). Estamos  dedicados a expandir nossos conhecimentos e habilidades nessa plataforma líder de computação em nuvem.
                    ...
                    Agradecemos por visitar nosso site e esperamos que você aprecie o que criamos. Se você deseja entrar em contato conosco ou saber mais sobre nossas experiências, não hesite em nos contatar.</p>
            </div>
        </main>
    );
}